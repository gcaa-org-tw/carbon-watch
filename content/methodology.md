...
1. 2030年溫室氣體絕對減量目標
  * 超乎期待：減量目標超越IPCC減量目標（43%）
  * 合乎標準：減量目標超越國家減量目標（26%），未達IPCC減量目標（43%）
  * 有待加強：減量目標未達國家減量目標（26%）
  * 遠低於期望：未設定2030年絕對減量目標；缺乏基準年／基準年排放量；其他基礎資料缺乏問題
2. 2030年再生能源使用率目標
  * 超乎期待：承諾RE100，且目標承諾超越國家使用率（30%）
  * 合乎標準：目標承諾超越國家使用率（30%）
  * 有待加強：目標承諾超越10%
  * 遠低於期望：再生能源目標承諾未達10% 或 未設定任何再生能源使用目標
3. 2030年能源效率進步目標
  * 超乎期待：節能目標設定超越2%
  * 合乎標準：節能目標設定超越1.5%
  * 有待加強：節能目標設定超越1%
  * 遠低於期望：節能目標設定低於1% 或 未設定節能目標
4. 前一年度再生能源使用率
  * 超乎期待：再生能源使用率超越15%
  * 合乎標準：再生能源使用率超越10%
  * 有待加強：再生能源使用率超越5%
  * 遠低於期望：再生能源使用率未達5% 或 未使用再生能源
5. 近三年能效進步率
  * 超乎期待：能效進步率超越3%
  * 合乎標準：能效進步率超越2%
  * 有待加強：能效進步率超越1%
  * 遠低於期望：能效進步率未達1%；缺乏資料無法計算
6. 範疇三減量規劃
  * 超乎期待：範疇三減量目標取得第三方驗證
  * 合乎標準：設定範疇三減量目標 且 設定範疇三減量規劃
  * 有待加強：未揭露範疇三排放量 或 未設定範疇三減量規劃（二者缺一）
  * 遠低於期望：未揭露範疇三排放量 且 未設定範疇三減量規劃（二者皆無）
